...
(function() {
    ...
    window.UEDITOR_CONFIG = {
        ...
        UEDITOR_HOME_URL: URL
                ...
                , toolbars: [
            ['fullscreen', 'source', '|', 'undo', 'redo', '|', 'horizontal', 'date', 'time', 'spechars', 'snapscreen', 'wordimage', '|',
                'directionalityltr', 'directionalityrtl', 'indent', '|', 'strikethrough', 'removeformat', 'formatmatch', 'autotypeset', 'blockquote', 'pasteplain', '|',
                'backcolor', 'insertorderedlist', 'insertunorderedlist', 'selectall', 'cleardoc', '|',
                'rowspacingtop', 'rowspacingbottom', 'lineheight', '|', 'insertvideo', 'attachment', '|',
                'customstyle', 'paragraph', 'fontfamily', 'fontsize', 'forecolor', 'bold', 'italic', 'underline', 'fontborder', '|',
                'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify', '|',
                'link', 'unlink', 'anchor', '|', 'imagenone', 'imageleft', 'imageright', 'imagecenter', '|', 'insertimage', 'emotion',
